...
const containsAnd = (arr) => {
  ...
  return arr.filter((element) => {
    ...
    return typeof element === 'string' && element.includes('and');
  });
};
...
const getStatName = (arr, minBaseStat) => {
  ...
  const filteredStats = arr.filter((element) => {
...
const getCharactersWithoutChildren = (arr) => {
  ...
  return arr.filter((character) => {
    ...
    return !character.children || character.children.length === 0;
  });
};
/* ------------------------------------------------------------------------------------------------
...
const evenOddNumericValues = (arr) => {
  ...
  const numericValues = arr.filter((element) => {
    return typeof element === 'number';
  });


  return numericValues.map((element) => {
